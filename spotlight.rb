...
if opts[:output]
	...
	swrite(wb_object,"Users",["Name","SamAccountName","When Created","Expires","Enabled","Time Since bad password", "Member Of","Hash","Hash Type","Password","Found Externally"], LDAPData::User.all_users, [:@name,:@samaccountname, :@whencreated, :@accountexpires,:@enabled, 
